...
function TVPage() {
    ...
    async function fetchApi() {
      const url = `https://api.themoviedb.org/3/tv/top_rated?api_key=9b48421e56beff9d0381692f8b0ee7d7&language=en-US&${page}`;
  ...
  return (
    ...
    <h1 className="page_title"><span>Tv </span>Shows</h1>
